...
> Upstream record, imported through `a10ef152`. This is not this fork's runtime
> certification or cutover authorization. The [fork integration boundary](upstream-integration.md)
> preserves Latest/GPT-6 Pro and direct-CDP ordinary/Batch execution.
